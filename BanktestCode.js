...
let Chaincode = class {
  ...
  async doInnerTransaction(stub, args) {
    ...
    console.info('============= START : changeCarowner ===========');
    if (args.length != 3) {
      throw new Error('Incorrect number of arguments. Expecting 3:[BankIDFrom,BankIDTo,Asset]');
    }
    ...
    if(bankF.Asset<args[2]){
        throw new Error('Incorrect number of arguments. Expecting 2');
    }else{
        bankF.Asset=bankF.Asset-args[2];
        bankT.Asset=bankT.Asset+args[2];
    }
